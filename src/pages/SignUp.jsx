            ...
            <div className='user-details'>
              ...
              <div className='input-wrapper'>
                ...
                <div className='input-box'>
                  <input type={showPassword ? 'text' : 'password'} id='password' placeholder='enter your password' value={values.password} onChange={handleChange} />
                  <button type="button" onClick={togglePasswordVisibility} className='iconEye'>
              ...
              <div className='input-wrapper'>
                ...
                <div className='input-box'>
                  <input type={showConfirmPassword ? 'text' : 'password'} id='confirmPassword' placeholder='confirm your password' value={values.confirmPassword} onChange={handleChange} />
                  <button type="button" onClick={toggleConfirmPasswordVisibility} className='iconEye'>
